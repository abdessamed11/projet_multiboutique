                            ...
                            <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile ">
                                <ul class="kt-menu__nav ">
                                    ...
                                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                                        aria-haspopup="true"><a href="{{url('/influs')}}"
                                            class="kt-menu__link kt-menu__toggle"><span
            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3 class="title">Pages <span>/ Influenceurs</span></h3>
                    </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-bordered data-table data-table-default">
                                ...
                                <tbody>
                                    @foreach($influs as $influ)
                                    <tr>
                                        <td>{{ $influ->nom }}</td>
                                        <td>{{ $influ->prenom }}</td>
                                        <td>{{ $influ->ville }}</td>
                                        <td>{{ $influ->telephone }}</td>
                                        <td>{{ $influ->facebook }}</td>
                                        <td>{{ $influ->instagram }}</td>
                                        <td>{{ $influ->youtube }}</td>
                                        <td>
                                            <form action="{{ url('publier/'.$influ->id) }}" method="post">
