	...
	<body class="kt-page--loading-enabled kt-page--loading kt-page--fixed kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--left kt-aside--fixed kt-page--loading">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="index.html">
					<img alt="Logo" src="{{ asset('assetss/media/logos/logo-9-sm.png') }}" />
				</a>
			</div>
						...
						<div class="kt-container kt-container--fluid">
							...
							<div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
								<a class="kt-header__brand-logo" href="index.html">
									<img alt="Logo" src="{{ asset('assetss/media/logos/logo-9.png') }}" />
								</a>
							</div>
							...
							<div class="kt-header__topbar kt-grid__item">
													...
													<div class="kt-mycart__item">
														<div class="kt-mycart__container">
															...
															<a href="#" class="kt-mycart__pic">
																<img src="{{ asset('assetss/media/products/product9.jpg') }}" title="">
															</a>
														</div>
													</div>
													<div class="kt-mycart__item">
														<div class="kt-mycart__container">
															...
															<a href="#" class="kt-mycart__pic">
																<img src="{{ asset('assetss/media/products/product13.jpg') }}" title="">
															</a>
														</div>
													</div>
													<div class="kt-mycart__item">
														<div class="kt-mycart__container">
															...
															<a href="#" class="kt-mycart__pic">
																<img src="{{ asset('assetss/media/products/product16.jpg') }}" title="">
															</a>
														</div>
													</div>
													<div class="kt-mycart__item">
														<div class="kt-mycart__container">
															...
															<a href="#" class="kt-mycart__pic">
																<img src="{{ asset('assetss/media/products/product15.jpg') }}" title="" alt="">
															</a>
														</div>
													</div>
												</div>
								...
								<div class="kt-header__topbar-item kt-header__topbar-item--langs">
									<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
										<span class="kt-header__topbar-icon">
											<img class="" src="{{ asset('assetss/media/flags/020-flag.svg') }}" alt="" />
										</span>
									</div>
										...
										<ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
											<li class="kt-nav__item kt-nav__item--active">
												<a href="#" class="kt-nav__link">
													<span class="kt-nav__link-icon"><img src="{{ asset('assetss/media/flags/020-flag.svg') }}" alt="" /></span>
													<span class="kt-nav__link-text">English</span>
												</a>
											</li>
											<li class="kt-nav__item">
												<a href="#" class="kt-nav__link">
													<span class="kt-nav__link-icon"><img src="{{ asset('assetss/media/flags/016-spain.svg') }}" alt="" /></span>
													<span class="kt-nav__link-text">Spanish</span>
												</a>
											</li>
											<li class="kt-nav__item">
												<a href="#" class="kt-nav__link">
													<span class="kt-nav__link-icon"><img src="{{ asset('assetss/media/flags/017-germany.svg') }}" alt="" /></span>
								...
								<div class="kt-header__topbar-item kt-header__topbar-item--user">
									<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
										...
										<img alt="Pic" src="{{ asset('assetss/media/users/300_21.jpg') }}" />
									...
									<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
										...
										<div class="kt-user-card kt-user-card--skin-light kt-notification-item-padding-x">
											<div class="kt-user-card__avatar">
												<img class="kt-hidden-" alt="Pic" src="{{ asset('assetss/media/users/300_25.jpg') }}" />
														...
														<div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
															...
															<div class="kt-timeline-v2__item">
																...
																<div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
																	<a href="#"><img src="{{ asset('assetss/media/users/100_4.jpg') }}" title=""></a>
																	<a href="#"><img src="{{ asset('assetss/media/users/100_13.jpg') }}" title=""></a>
																	<a href="#"><img src="{{ asset('assetss/media/users/100_11.jpg') }}" title=""></a>
																	<a href="#"><img src="{{ asset('assetss/media/users/100_14.jpg') }}" title=""></a>
																</div>
															</div>
															<div class="kt-timeline-v2__item">
									...
									<div class="row">
										...
										<div class="col-xl-4">
											...
											<div class="kt-portlet kt-portlet--height-fluid kt-widget19">
												<div class="kt-portlet__body kt-portlet__body--fit">
													<div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url({{ asset('assetss/media//products/product4.jpg') }})">
													...
													<div class="kt-widget19__wrapper">
														<div class="kt-widget19__content">
															<div class="kt-widget19__userpic">
																<img src="{{ asset('assetss/media//users/user1.jpg') }}" alt="">
															</div>
														...
														<div class="tab-pane active" id="kt_widget5_tab1_content" aria-expanded="true">
															<div class="kt-widget5">
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="{{ asset('assetss/media//products/product27.jpg') }}" alt="">
																		</div>
																...
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="{{ asset('assetss/media//products/product22.jpg') }}" alt="">
																		</div>
																		<div class="kt-widget5__section">
																			<a href="#" class="kt-widget5__title">
																				Branding Mockup
																...
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="{{ asset('assetss/media//products/product15.jpg') }}" alt="">
																		</div>
																		<div class="kt-widget5__section">
																			<a href="#" class="kt-widget5__title">
																				Awesome Mobile App
														...
														<div class="tab-pane" id="kt_widget5_tab2_content">
															<div class="kt-widget5">
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="{{ asset('assetss/media//products/product10.jpg') }}" alt="">
																		</div>
																		<div class="kt-widget5__section">
																			<a href="#" class="kt-widget5__title">
																				Branding Mockup
																...
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="{{ asset('assetss/media//products/product11.jpg') }}" alt="">
																		</div>
																		<div class="kt-widget5__section">
																			<a href="#" class="kt-widget5__title">
																				Awesome Mobile App
																...
																<div class="kt-widget5__item">
																	<div class="kt-widget5__content">
																		<div class="kt-widget5__pic">
																			<img class="kt-widget7__img" src="{{ asset('assetss/media//products/product6.jpg') }}" alt="">
																		</div>
																		<div class="kt-widget5__section">
																			<a href="#" class="kt-widget5__title">
																				Great Logo Designn
													...
													<div class="tab-content">
															...
															<div class="kt-widget4">
																<div class="kt-widget4__item">
																	<div class="kt-widget4__pic kt-widget4__pic--pic">
																		<img src="{{ asset('assetss/media/users/100_4.jpg') }}" alt="">
																	</div>
																...
																<div class="kt-widget4__item">
																	<div class="kt-widget4__pic kt-widget4__pic--pic">
																		<img src="{{ asset('assetss/media/users/100_14.jpg') }}" alt="">
																	</div>
																	<div class="kt-widget4__info">
																		<a href="#" class="kt-widget4__username">
																			Milano Esco
																...
																<div class="kt-widget4__item">
																	<div class="kt-widget4__pic kt-widget4__pic--pic">
																		<img src="{{ asset('assetss/media/users/100_11.jpg') }}" alt="">
																	</div>
																	<div class="kt-widget4__info">
																		<a href="#" class="kt-widget4__username">
																			Nick Bold
																...
																<div class="kt-widget4__item">
																	<div class="kt-widget4__pic kt-widget4__pic--pic">
																		<img src="{{ asset('assetss/media/users/100_1.jpg') }}" alt="">
																	</div>
																	<div class="kt-widget4__info">
																		<a href="#" class="kt-widget4__username">
																			Wiltor Delton
																...
																<div class="kt-widget4__item">
																	<div class="kt-widget4__pic kt-widget4__pic--pic">
																		<img src="{{ asset('assetss/media/users/100_5.jpg') }}" alt="">
																	</div>
																	<div class="kt-widget4__info">
																		<a href="#" class="kt-widget4__username">
																			Nick Stone
														...
														<div class="tab-pane" id="kt_widget4_tab2_content">
															<div class="kt-widget4">
																<div class="kt-widget4__item">
																	<div class="kt-widget4__pic kt-widget4__pic--pic">
																		<img src="{{ asset('assetss/media/users/100_2.jpg') }}" alt="">
																	</div>
																	<div class="kt-widget4__info">
																		<a href="#" class="kt-widget4__username">
																			Kristika Bold
																...
																<div class="kt-widget4__item">
																	<div class="kt-widget4__pic kt-widget4__pic--pic">
																		<img src="{{ asset('assetss/media/users/100_13.jpg') }}" alt="">
																	</div>
																	<div class="kt-widget4__info">
																		<a href="#" class="kt-widget4__username">
																			Ron Silk
																...
																<div class="kt-widget4__item">
																	<div class="kt-widget4__pic kt-widget4__pic--pic">
																		<img src="{{ asset('assetss/media/users/100_9.jpg') }}" alt="">
																	</div>
																	<div class="kt-widget4__info">
																		<a href="#" class="kt-widget4__username">
																			Nick Bold
																...
																<div class="kt-widget4__item">
																	<div class="kt-widget4__pic kt-widget4__pic--pic">
																		<img src="{{ asset('assetss/media/users/100_8.jpg') }}" alt="">
																	</div>
																	<div class="kt-widget4__info">
																		<a href="#" class="kt-widget4__username">
																			Nick Bold
												...
												<div class="kt-portlet__body">
													<div class="kt-widget3">
														<div class="kt-widget3__item">
															<div class="kt-widget3__header">
																<div class="kt-widget3__user-img">
																	<img class="kt-widget3__img" src="{{ asset('assetss/media/users/user1.jpg') }}" alt="">
																</div>
														...
														<div class="kt-widget3__item">
															<div class="kt-widget3__header">
																<div class="kt-widget3__user-img">
																	<img class="kt-widget3__img" src="{{ asset('assetss/media/users/user4.jpg') }}" alt="">
																</div>
																<div class="kt-widget3__info">
																	<a href="#" class="kt-widget3__username">
																		Lebron King James
														...
														<div class="kt-widget3__item">
															<div class="kt-widget3__header">
																<div class="kt-widget3__user-img">
																	<img class="kt-widget3__img" src="{{ asset('assetss/media/users/user5.jpg') }}" alt="">
																</div>
																<div class="kt-widget3__info">
																	<a href="#" class="kt-widget3__username">
																		Deb Gibson
			...
			<div class="kt-demo-panel__body">
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-_Default.jpg') }}" alt="" />
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-2.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-3.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-4.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-5.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-6.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-7.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-8.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item kt-demo-panel__item--active">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-9.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-10.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-11.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-12.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-13.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="{{ asset('assetss/media/demos/Demo-14.jpg') }}" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
