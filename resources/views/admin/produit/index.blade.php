                            ...
                            <table class="table table-bordered data-table data-table-default">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('/storage/'.$Produit->image_produit) }}" alt=""></td>
                                        <td>{{ $Produit->description }}</td>
                                        <td>{{ $Produit->id_boutique }}</td>
                                        <td>{{ $Produit->id_categorie_produit }}</td>
                                       
                                        <td>
                                            <form action="{{ url('produit/'.$Produit->id) }}" method="post">
                                                <a href="{{ url('produit/'.$Produit->id.'/edit')}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
