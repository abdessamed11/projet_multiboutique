        ...
        <div class="content-body">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-30">
                    <div class="box">
                        <div class="box-head">
                            <h3 class="title">Formulaire de modification de Produit</h3>
                        </div>
                        <div class="box-body">
                        <form action="{{ url('produit/'.$produits->id)}}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-3 mb-20">
                                        <div class="form-group">
                                            <label for="nom_produit">Nom</label>
                                            <input type="text" class="form-control" name="nom_produit" id="nom_produit" value="{{$produits->nom_produit}}"
                                                placeholder="Ex:">
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-20">
                                        <div class="form-group">
                                            ...
                                            <img src="{{ asset('/storage/'.$produits->image_produit) }}" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-20">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3 mb-20">
                                        <div class="form-group">
                                            ...
                                            <textarea  class="form-control" name="description_produit" id="description_produit" 
                                                placeholder="Ex:">{{$produits->description}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-20">
                                        <div class="form-group">
                                            <button type="submit"
                                                class="btn btn-outline-primary btn-block">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
