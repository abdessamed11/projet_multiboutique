            ...
            <div class="row">
                ...
                <div class="col-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form action="{{ url('boutique/'.$boutique->id)}}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-20">
                                        <div class="form-group">
                                            ...
                                            <textarea  class="form-control" name="description_boutique" id="description_boutique"
                                                placeholder="Ex:">{{$boutique->desc_boutique}}</textarea>
                                        </div>
                                    </div>
