        ...
        <div class="content-body">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-30">
                    <div class="box">
                        <div class="box-head">
                            <h3 class="title">Formulaire de modification de Categorie produit</h3>
                        </div>
                        <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-20">
                                        <div class="form-group">
                                            <label for="nom_categorie_produit">Categorie produit</label>
                                            <input type="text" class="form-control" name="nom_categorie_produit" id="nom_categorie_produit"
                                            value="{{ $categorie_produit->nom_categorie_produit}}" >
                                        </div>
                                    </div>
