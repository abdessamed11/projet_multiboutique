                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-bordered data-table data-table-default">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $categorie_boutique->nom_categorie_boutique }}</td>
                                        <td>
                                            <form action="{{ url('categorie/boutique/'.$categorie_boutique->id) }}" method="post">
                                                <a href="{{ url('categorie/boutique/'.$categorie_boutique->id.'/edit')}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
