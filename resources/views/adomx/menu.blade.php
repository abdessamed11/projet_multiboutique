<nav class="side-header-menu" id="side-header-menu">
    <ul>
        <li class="has-sub-menu"><a href="#"><i class="ti-home"></i> <span>Ville</span></a>
            <ul class="side-header-sub-menu">
                <li><a href="{{ url('/ville') }}"><span>List</span></a></li>
                <li><a href="{{ url('/ville/create/') }}"><span>Ajouter</span></a></li>
            </ul>
        </li>
        <li class="has-sub-menu"><a href="#"><i class="ti-home">  </i> <span>Categorie Boutique</span></a>
            <ul class="side-header-sub-menu">
                <li><a href="{{ url('/categorie/boutique') }}"><span>List</span></a></li>
                <li><a href="{{ url('/categorie/boutique/create/') }}"><span>Ajouter</span></a></li>
            </ul>
        </li>
        <li class="has-sub-menu"><a href="#"><i class="ti-home">  </i> <span>Categorie Produit</span></a>
            <ul class="side-header-sub-menu">
                <li><a href="{{ url('/categorie/produit') }}"><span>List</span></a></li>
                <li><a href="{{ url('/categorie/produit/create/') }}"><span>Ajouter</span></a></li>
            </ul>
        </li>
        <li class="has-sub-menu"><a href="#"><i class="ti-home">  </i> <span>User</span></a>
            <ul class="side-header-sub-menu">
                <li><a href="{{ url('/user') }}"><span>List</span></a></li>
                <li><a href="{{ url('/user/create/') }}"><span>Ajouter</span></a></li>
            </ul>
        </li>
        <li class="has-sub-menu"><a href="#"><i class="ti-home">  </i> <span>Boutique</span></a>
            <ul class="side-header-sub-menu">
                <li><a href="{{ url('/boutique') }}"><span>List</span></a></li>
                <li><a href="{{ url('/boutique/create/') }}"><span>Ajouter</span></a></li>
            </ul>
        </li>
        <li class="has-sub-menu"><a href="#"><i class="ti-home">  </i> <span>Produit</span></a>
            <ul class="side-header-sub-menu">
                <li><a href="{{ url('/produit') }}"><span>List</span></a></li>
                <li><a href="{{ url('/produit/create/') }}"><span>Ajouter</span></a></li>
            </ul>
        </li>
